...
def test_known_value_matches_reference():
    ...
    #   astropy: alt=73.09, az=66.85  (this spherical transform: alt=73.3, az=67.1,
    #   agreeing to the formula's ~arcminute precision).
    alt, az = radec_to_altaz(21.0213, 44.5333, 40.0, -74.0, 1782799000.0)
    assert abs(alt - 73.09) < 1.5
    assert abs(az - 66.85) < 2.0
